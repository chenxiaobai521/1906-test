        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="{{url('weather')}}">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('show')}}">素材展示</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="{{url('create')}}">素材添加</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="{{url('/channel/index')}}">渠道展示</a>
                            </li>
                            <li>
